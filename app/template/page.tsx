        ...
        <main className="flex min-h-screen flex-col w-full py-5 px-4 items-start justify-between ">
            <div className="flex w-full  flex-col px-8  lg:px-0 relative   justify-start items-start">
                ...
                <span className='text-md  text-neutral-200 max-w-2xl mb-2 '>
                    ...
                    you can also use it as a base to build your own form (In the next step, we will set up the configuration based on the languages) . 

                </span>

                {/* <div className="flex flex-col py-4  gap-y-4 w-full  "> 

                    <h2 className='text-2xl '> Choose what language you use  </h2>
                    <select className="bg-neutral-900 outline border  border-neutral-700/50 w-1/4 p-2 rounded-md text-neutral-200" >
                          {tabLanguage.map((comp:any)=>(

...
const FormRegisterEmail2 = () => {
  ...
  const buttonClasses =
    "px-3 w-1/3 rounded-full py-1  group  flex justify-center items-center text-black font-bold hover:bg-neutral-900 hover:text-white transition-all ease duration-300  text-sm bg-yellow-500";
  const inputClasses =
...
export default FormRegisterEmail2;

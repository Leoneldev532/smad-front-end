...
const FormRegisterEmail1 = () => {
  ...
  const formClasses =
    "flex bg-neutral-700 border border-neutral-700/40 py-0.5 px-0.5 overflow-hidden rounded-xl justify-between";
  const buttonClasses =
    "px-3 w-1/3 rounded-xl py-1  group  flex justify-center items-center text-black font-bold hover:bg-neutral-900 hover:text-white transition-all ease duration-300  text-sm bg-yellow-500";
  const inputClasses =
